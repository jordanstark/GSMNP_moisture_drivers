...
for(i in 14:nlayers(prec_2020)){
 ...
 out <- prec_2020[[i]] * k^(-1*i) +
    prec_2020[[(i-1)]] * k^(-1*(i+1)) +
    prec_2020[[i-2]] * k^(-1*(i+2)) +
    prec_2020[[i-3]] * k^(-1*(i+3)) +
    prec_2020[[i-4]] * k^(-1*(i+4)) +
    prec_2020[[i-5]] * k^(-1*(i+5)) +
    prec_2020[[i-6]] * k^(-1*(i+6)) +
    prec_2020[[i-7]] * k^(-1*(i+7)) +
    prec_2020[[i-8]] * k^(-1*(i+8)) +
    prec_2020[[i-9]] * k^(-1*(i+9)) +
    prec_2020[[i-10]] * k^(-1*(i+10)) +
    prec_2020[[i-11]] * k^(-1*(i+11)) +
    prec_2020[[i-12]] * k^(-1*(i+12)) +
    prec_2020[[i-13]] * k^(-1*(i+13))
...
for(i in 14:nlayers(prec_2021)){
  ...
  out <- prec_2021[[i]] * k^(-1*i) +
    prec_2021[[(i-1)]] * k^(-1*(i+1)) +
    prec_2021[[i-2]] * k^(-1*(i+2)) +
    prec_2021[[i-3]] * k^(-1*(i+3)) +
    prec_2021[[i-4]] * k^(-1*(i+4)) +
    prec_2021[[i-5]] * k^(-1*(i+5)) +
    prec_2021[[i-6]] * k^(-1*(i+6)) +
    prec_2021[[i-7]] * k^(-1*(i+7)) +
    prec_2021[[i-8]] * k^(-1*(i+8)) +
    prec_2021[[i-9]] * k^(-1*(i+9)) +
    prec_2021[[i-10]] * k^(-1*(i+10)) +
    prec_2021[[i-11]] * k^(-1*(i+11)) +
    prec_2021[[i-12]] * k^(-1*(i+12)) +
    prec_2021[[i-13]] * k^(-1*(i+13))
